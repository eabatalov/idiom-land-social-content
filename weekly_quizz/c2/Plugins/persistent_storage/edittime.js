...
{
	return {
		"name":			"Persistent storage",// as appears in 'insert object' dialog, can be changed as long as "id" stays the same
		"id":			"PersistentStoragePlugin",		// this is used to identify this plugin and is saved to the project; never change it
...
var property_list = [
    new cr.Property(ept_text, "Storage ID", "Storage ID", "Storage ID")
];
